...
urlpatterns = patterns('',
    ...
    url(r'^revision/(?P<transaction_id>[^/]+)/$', login_required(v.TransactionItemRevisionView.as_view()), name='bookish-cash_revison_list'),
    url(r'^receipt$', login_required(v.TransactionListView.as_view()), {'transaction_type': 'R'}, name='bookish-receipt_list'),
    url(r'^receipt/edit$', login_required(v.TransactionCreate.as_view()), {'transaction_type': 'R'}, name='bookish-receipt_edit'),
    url(r'^bank$', login_required(v.TransactionListView.as_view()), {'transaction_type': 'B'}, name='bookish-bank_list'),
    url(r'^bank/edit$', login_required(v.TransactionCreate.as_view()), {'transaction_type': 'B'}, name='bookish-bank_edit'),
    url(r'^invoice$', login_required(v.TransactionListView.as_view()), {'transaction_type': 'I'}, name='bookish-invoice_list'),
    url(r'^invoices/edit$', login_required(v.TransactionCreate.as_view()), {'transaction_type': 'I'}, name='bookish-invoice_edit'),
    url(r'^mileage$', login_required(v.TransactionListView.as_view()), {'transaction_type': 'M'}, name='bookish-mileage_list'),
    url(r'^mileage/edit$', login_required(v.TransactionCreate.as_view()), {'transaction_type': 'M'}, name='bookish-mileage_edit'),
