...
urlpatterns = patterns('',
    ...
    url(r'^cash$', login_required(v.CashListView.as_view()), {'transaction_type': 'C'}, name='bookish-cash_list'),
    ...
    url(r'^receipt$', login_required(v.CashListView.as_view()), {'transaction_type': 'B'}, name='bookish-receipt_list'),
